...
// ----------------------------------------------------------------------------
// DEMO #2: Getting untyped AST from the F# compiler
// ----------------------------------------------------------------------------
...
// TASK #2: Write tool that calculates the depth of branching to give a 
// warning for too complex code. For example:
//
//  match x with
//  | Some v -> 
//      if v = 0 then (if z = 3 then 11 else 42)
//      else 5
//  | None -> 1
//
// This sample has depth of branching 3 (match, if, nested if).
// Or implement some other interesting complexity test :-)