...
wb.Countries.Lithuania.Indicators.``School enrollment, tertiary (% gross)``
|> Chart.Line

Chart.Combine(
  [ Chart.Line(wb.Countries.Lithuania.Indicators.``School enrollment, tertiary, female (% gross)``, "Female")
    Chart.Line(wb.Countries.Lithuania.Indicators.``School enrollment, tertiary, male (% gross)``, "Male")
  ]).WithLegend()
